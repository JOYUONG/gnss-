...
import h5py
import os
import geshi_cnn_spf as geshiann
    ...
    def __init__(self, h5_path):
        ...
        with h5py.File(h5_path, 'r') as f:
            ...
            for key in tqdm(f.keys(), desc="加载数据集"):
                ...
                affected_mask = receivers['ri_pw'] == 1
...
def train_model():
    # 参数设置
    h5_path = "training_data_cnn_spf.h5"
    num_samples = 1000
    batch_size = 64
    ...
    for epoch in range(30):
        ...
        if avg_val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), "best_cnnspfmodel_stage.pth")
    
    print("\n训练完成")

class NeuralLocalizer:
    """神经网络定位器"""
    def __init__(self, model_path="best_cnnspfmodel_stage.pth"):
...
if __name__ == "__main__":
    ...
    with tqdm(range(num_simulations), desc="运行仿真", unit="sim") as sim_pbar:
        for sim in sim_pbar:
            ...
            # 绘制接收机
            normal_mask = receivers['ri_pw'] == 0
            interfered_mask = receivers['ri_pw'] == 1
